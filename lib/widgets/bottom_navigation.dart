...
import '../services/appointment_count_provider.dart';
...
class BottomNavigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final appointmentCountProvider = Provider.of<AppointmentCountProvider>(context);
    final appointmentCount = appointmentCountProvider.appointmentCount;
