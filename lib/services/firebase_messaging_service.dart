...
class FirebaseMessagingService {
  ...
  void _onForegroundMessage(RemoteMessage message) {
    ...
    if (notificationData != null) {
      ...
      //Log the foreground push notification
      _logPushNotificationEvent(message.data);
    }
  }
  ...
  void _onMessageOpenedApp(RemoteMessage message) {
    ...
    // Log push notification opened event when app is opened by tapping a notification
    _logPushNotificationEvent(message.data);

    // TODO: Add navigation or specific handling based on message data
  }

  // Function to log push notification events to Facebook
  void _logPushNotificationEvent(Map<String, dynamic> pushData) {
    try {
      // Convert the payload to a map of <String, String>
      final Map<String, String> stringPayload = pushData.map((key, value) {
        return MapEntry(key, value.toString()); // Convert all values to string
      });

      facebookAppEvents.logPushNotificationOpen(payload: stringPayload);
      print('Successfully logged push notification to Facebook');
    } catch (e) {
      print('Error logging push notification to Facebook: $e');
    }
  }
}
