        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return SizedBox(
            ...
            child: Column(
              ...
              children: [
                _buildDiagnosticRow(
                    context, 'Complaint:', consultation.compliant ?? "N/A"),
                _buildDiagnosticRow(
                    context, 'Diagnosis:', consultation.diagnosis ?? "N/A"),
                _buildDiagnosticRow(context, 'Consultation Type:',
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text('Complaint: ${consultation.compliant ?? "N/A"}',
                    style: detailStyle),
                pw.Text('Diagnosis: ${consultation.diagnosis ?? "N/A"}',
                    style: detailStyle),
                pw.Text('Consultation Type: ${consultation.consultationType ??
                    "N/A"}', style: detailStyle),
            ...
            return pw.Padding(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 10),
                  pw.Text('Patient Information', style: headingStyle),
                  pw.Text('Complaint: ${consultation.compliant ?? "N/A"}', style: detailStyle),
