...
-----END PUBLIC KEY-----''';
  ...
  Future<void> _activatePackageAndThenLogin(
    ...
    try {
      ...
      if (activatePackageResponse != null &&
        ...
        // Call package payment success API
  ...
  Future<void> _callPackagePaymentSuccessAPI() async {
    final String? userId = SharedPreferencesManager.getString('id');
    final String apiUrl = '${ApiService.irfanBaseUrl}stripe/payment-success?session_id=easypaisa&profile_id=$userId&package_id=${widget.packageId}';
  ...
  Future<void> _callAppointmentPaymentSuccessAPI(appointmentId) async {
    final String? userId = SharedPreferencesManager.getString('id');
    final String apiUrl = '${ApiService.irfanBaseUrl}stripe/appointment-payment-success?session_id=easypaisa&profile_id=$userId&doctor_id=${widget.doctorId}&appointmentId=$appointmentId&paymentMethod=easypaisa';
