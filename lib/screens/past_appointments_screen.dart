  ...
  Future<void> _backgroundRefresh() async {
    ...
    try {
      ...
      if (upcomingResponse != null && upcomingResponse.payLoad != null) {
        // Use a more robust equality check to prevent unnecessary updates
        if (!DeepCollectionEquality().equals(_upcomingAppointments, upcomingResponse.payLoad)) {
          setState(() {
        ...
        setState(() {
          ...
          _upcomingAppointments = []; // Ensure list is cleared when no data
        });
      }
      ...
      if (pastResponse != null && pastResponse.payLoad != null) {
        if (!DeepCollectionEquality().equals(_pastAppointments, pastResponse.payLoad)) {
          setState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Conditionally render the UpcomingAppointmentsList or the NoAppointments widget.
          _upcomingAppointments.isNotEmpty
              ? UpcomingAppointmentsList(appointments: _upcomingAppointments)
              : const NoAppointments(), // Use the standalone NoAppointments widget
